            ...
            LoadFromJson(string jsonFilePath)
        {
            ...
            foreach (var seJson in root.StatusEffects)
            {
                var effect = new StatusEffectData
                {
                    ...
                    Intensity = seJson.Intensity,
                    IntensityType = Enum.Parse<IntensityType>(seJson.IntensityType),
                    Duration = seJson.Duration,
            ...
            foreach (var deJson in root.DeckEffects)
            {
                var effect = new DeckEffectData
                {
                    ...
                    Intensity = deJson.Intensity,
                    IntensityType = Enum.Parse<IntensityType>(deJson.IntensityType),
                    Duration = deJson.Duration,
