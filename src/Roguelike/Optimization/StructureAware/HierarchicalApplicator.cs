...
namespace Roguelike.Optimization
{
    ...
    public static class HierarchicalApplicator
    {
        ...
        {
            // Get floor-specific difficulty multiplier for gradual progression
            ...
            foreach (var enemy in enemyPool.EnemiesById.Values)
            {
                ...
                healthScalar *= floorDifficultyMult; // Apply floor-specific progression
                ...
                foreach (var weightedAction in enemy.ActionSet)
                {
                    ...
                    switch (action.Type)
                    {
                        case ActionType.DealDamage:
                            ...
                            dmgScalar *= floorDifficultyMult; // Apply floor-specific progression
