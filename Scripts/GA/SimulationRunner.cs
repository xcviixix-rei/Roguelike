...
namespace Roguelike.GA
{
    public class SimulationRunner
    {
        ...
        public SimulationRunner(IPlayerAgent agent, HeroData baseHero, CardPool cards, RelicPool relics, EnemyPool enemies, EffectPool effects, EventPool events, Dictionary<RoomType, RoomData> roomConfigs)
        {
            _agent = agent;
            _baseHero = baseHero;
            _baseCards = cards;
